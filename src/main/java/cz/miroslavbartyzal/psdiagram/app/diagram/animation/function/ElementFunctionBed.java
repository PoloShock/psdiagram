...
//    }
            ...
            HashMap<String, String> variables)
    {
        ...
        if ((commandsCopy == null && (symbol instanceof Decision || symbol instanceof For || symbol instanceof IO || symbol instanceof cz.miroslavbartyzal.psdiagram.app.diagram.flowchart.symbols.Process))) {
        ...
        } else if (symbol instanceof cz.miroslavbartyzal.psdiagram.app.diagram.flowchart.symbols.Process) {
