 ...
 */
package cz.miroslavbartyzal.psdiagram.app.diagram.codeImportExport;

import cz.miroslavbartyzal.psdiagram.app.diagram.flowchart.Flowchart;
import cz.miroslavbartyzal.psdiagram.app.diagram.flowchart.FlowchartElement;
...
import cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.documentFilters.*;
        ...
        while (!commands.isEmpty() && !errored) {
            ...
            try {
                ...
                if (command.matches("^\\s*[^\\'\\:\\+\\-\\*\\/ ]+ *[\\:\\+\\-\\*\\/]\\=[\\S\\s]+")) {
                    ...
                    if (!var.equals("")) {
                        cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.Process.generateValues(
                    ...
                    if (command.toLowerCase().startsWith("read")) {
                        ...
                        if (!command.equals("")) {
                            cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.IO.generateIValues(
                        ...
                        if (!command.equals("")) {
                            cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.IO.generateOValues(
                    ...
                    if (myCommand.contains(":=")) {
                        ...
                        if (!command.equals("")) {
                            cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.For.generateForValues(
                        ...
                        if (!command.equals("")) {
                            cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.For.generateForeachValues(
                    ...
                    if (!condition.equals("")) {
                        cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.LoopStart.generateValues(
                    ...
                    if (!condition.equals("")) {
                        cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.LoopEnd.generateValues(
                    ...
                    if (!conditionVar.equals("")) {
                        cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.Switch.generateValues(
                                actualElement,
                    ...
                    if (!condition.equals("")) {
                        cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.Decision.generateValues(
                                actualElement.getSymbol(), condition);
                        actualElement.getSymbol().setValueAndSize(
                                actualElement.getSymbol().getDefaultValue());
                    }
                    ...
                    switch (command.toLowerCase()) {
                        case "break":
                            cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.Goto.generateBreakValues(
                                    actualElement.getSymbol());
                            actualElement.getSymbol().setValueAndSize(
                                    actualElement.getSymbol().getDefaultValue());
                            break;
                        case "continue":
                            cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.Goto.generateContinueValues(
                                    actualElement.getSymbol());
                            actualElement.getSymbol().setValueAndSize(
                                    actualElement.getSymbol().getDefaultValue());
                            break;
                        default:
                            cz.miroslavbartyzal.psdiagram.app.diagram.gui.symbolFunctionForms.Goto.generateGotoValues(
                                    actualElement.getSymbol());
...
//        return sb.toString();
            ...
            if (segment != null) {
                for (FlowchartElement element : segment) {
                    ...
                    if (symbol.getCommands() != null) {
                        if (symbol instanceof cz.miroslavbartyzal.psdiagram.app.diagram.flowchart.symbols.Process || (symbol instanceof IO && symbol.getCommands().containsKey(
                                "var"))) {
    ...
    private static String generateSourceCode(LayoutSegment segment, String tabsDepth)
    {
        ...
        for (Iterator<LayoutElement> it = segment.iterator(); it.hasNext();) {
            ...
            try {
                ...
                if (symbol instanceof cz.miroslavbartyzal.psdiagram.app.diagram.flowchart.symbols.Process) {
                    if (symbol.getCommands() != null) {
    ...
    private static boolean containsFunctionalSymbols(LayoutSegment segment, int actualElementIndex)
    {
        for (int i = actualElementIndex + 1; i < segment.size(); i++) {
            ...
            if (symbol instanceof cz.miroslavbartyzal.psdiagram.app.diagram.flowchart.symbols.Process || symbol instanceof IO || symbol instanceof Decision || symbol instanceof For || symbol instanceof LoopStart || symbol instanceof Comment || symbol instanceof SubRoutine || symbol instanceof Goto || symbol instanceof GotoLabel
